...
# library(RecruitnetP)
## 
#devtools::install_github("EcologyR/RecruitnetP")
library(RecruitnetP)
data(RN)
data(RNCover)
dbinter<-RN[RN$Study_site==unique(RN$Study_site)[1:2],]
dbcover<-RNCover[RNCover$Study_site==unique(RN$Study_site)[1:2],]
