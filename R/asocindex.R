...
#'
#' @param inter a data frame which must include at least four columns named: "Study_site","Recruit","Canopy","Freq", with Freq being the number of recruits of a given species under each canopy species (including "Open", as a canopy species if the recruit is on the open (i.e. no canopy)), in each study sites. It can be obtained extracting the first element of the list generated by the function plot_to_com.
#' @param Canopy_all a data frame which must include at least three columns named: "Study_site","Canopy","Canopy_cover", with the last being the % of cover of each canopy species (or Open) in each study site. It can be be obtained extracting the second element of the list generated by the function plot_to_com.
