...
#'
#' @param inter a data frame which must include at least four columns named:
...
#'
#' @param Canopy_all a data frame which must include at least three columns named:
...
#'
#' @param adjlist a list with the community matrix with recruit and canopy species
...
#'
#' @return a data frame with the number of recruits observed under each canopy
