#' Function asocindex.It generates a data frame with the information required to calculate association indices, with the number of recruits observed under each canopy species and in the open for multiple study site
#'
