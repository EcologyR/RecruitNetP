...
#' under any species of canopy and in the open and its respective percentage of
...
#'
#' @return data frame with one row per site and nine columns:
...
#' Canopy_Freq and Open_Freq with the number of recuits observed under
#' that canopy species or in the Open, respectively and
